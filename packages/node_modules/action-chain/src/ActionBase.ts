          ...
          (props, executionContext, newPath) => {
            const executionContextCopy = {
              __execution: {
                ...
                operatorId: executionContext.__execution.operatorId + 1,
              },
              __path: newPath
                ? executionContext.__path.concat(newPath)
                : executionContext.__path.slice(),
            }
            const path = executionContextCopy.__path
            const prevResult = runOperators
              ? runOperators(props, executionContextCopy)
              : props
            ...
            function produceResult(currentValue) {
              ...
              const context = actionChain.getContext(executionContextCopy)
