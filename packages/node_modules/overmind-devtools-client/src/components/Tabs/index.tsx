    ...
    <div className={styles.wrapper}>
      ...
      <Tooltip text="State">
        <button
          className={css(
            styles.button,
            state.currentApp && state.currentTab === Tab.State && styles.activeButton
          )}
      ...
      <Tooltip text="Actions">
        ...
        >
          ...
          disabled={state.isConnecting}
            ...
            style={{
              opacity: state.currentApp && state.currentTab === Tab.Actions ? 1 : null,
            }}
          >
            <FaCogs />
          </button>
          ...
          <span
            ...
            onClick={() => !state.isConnecting && actions.changeTab(Tab.Actions)}
          >
      ...
      <Tooltip text="Charts">
        <button
          className={css(
            styles.button,
            state.currentApp && state.currentTab === Tab.Charts && styles.activeButton
          )}
          disabled={state.isConnecting}
      ...
      <Tooltip text="Components">
        <button
          className={css(
            styles.button,
            state.currentApp && state.currentTab === Tab.Components && styles.activeButton
          )}
          disabled={state.isConnecting}
      ...
      <Tooltip text="History">
        <button
          className={css(
            styles.button,
            state.currentApp && state.currentTab === Tab.History && styles.activeButton
          )}
          disabled={state.isConnecting}
      ...
      <Tooltip text="Flushes">
        <button
          className={css(
            styles.button,
            state.currentApp && state.currentTab === Tab.Flushes && styles.activeButton
          )}
          disabled={state.isConnecting}
      ...
      {process.env.NODE_ENV === 'development' ? (
        <Tooltip text="Console">
          <button
            className={css(
              styles.button,
              state.currentApp && state.currentTab === Tab.Console && styles.activeButton
            )}
            disabled={state.isConnecting}
