...
const state: State = {
  ...
  hasActionsError: derived((state: State) => {
    return Boolean(state.currentApp && Object.values(state.currentApp.actions).some(
  ...
  flushesStatePathCount: derived((state: State) =>
  ...
  currentAction: derived((state: State) =>
    state.currentApp.actions[state.currentApp.currentActionId]),
  currentChart: derived((state: State) =>
