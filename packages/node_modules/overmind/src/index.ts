...
function warnValueDeprecation() {
  if (!hasWarnedDeprecatedValue) {
    hasWarnedDeprecatedValue = true
    console.warn(
      'Overmind - The property VALUE on the CONTEXT has been deprecated, it is now passed as second argument: (context, value) => {}'
    )
  }
}
