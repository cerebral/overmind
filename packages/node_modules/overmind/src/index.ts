...
export namespace Operation {
  export type Mutate<Value = any> = TOperation.Mutate<IApp, Value>
  export type Map<Value, ReturnValue = Value> = TOperation.Map<
    IApp,
    Value,
    ReturnValue
  >
  export type Filter<Value = any> = TOperation.Filter<IApp, Value>
  export type When<Value = any> = TOperation.When<IApp, Value>
  export type Run<Value = any> = TOperation.Run<IApp, Value>
  export type Fork<Value = any> = TOperation.Fork<IApp, Value>
...
export default class Overmind<Config extends Configuration> implements BaseApp {
  ...
  constructor(configuration: Config, options: Options = {}) {
    ...
    */
    ...
    this.effects = Object.assign({}, configuration.effects || {}, {
      state: this.state,
    })
    ...
    /*
      The action chain with the effects
    */
    const actionChain = new ActionChain(this.effects, {
