...
export function fork<T, K, P extends string | number>(
  operation: OperatorContextFunction<T, P>,
  paths: { [U in P]: OperatorContextFunction<T, K> }
): IOperator<T, K> {
  return createOperator(
    'fork',
    utils.getFunctionName(operation),
