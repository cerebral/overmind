...
describe('Statecharts', () => {
  test('should wrap configs', () => {
    ...
    expect(instance.state.states).toEqual([['foo']])
  ...
  test('should allow nesting', () => {
    ...
    expect(instance.state.states).toEqual([['foo', 'a']])
    expect(instance.state.actions).toEqual({
      fooEntry: true,
      fooExit: true,
      aEntry: true,
    ...
    expect(instance.state.states).toEqual([['foo', 'b']])
    expect(instance.state.actions).toEqual({
      fooEntry: true,
      fooExit: true,
      aEntry: false,
  ...
  test('should allow parallel state charts', () => {
    ...
    const parallelChartA: Statechart<typeof config, 'foo' | 'bar'> = {
      initial: 'bar',
      states: {
        foo: {},
        bar: {
    ...
    const parallelChartB: Statechart<typeof config, 'foo' | 'bar'> = {
      initial: 'foo',
      states: {
        foo: {
          on: {
  ...
  test('should allow nested parallel state charts', () => {
    ...
    const nestedChartB: Statechart<typeof config, 'foo' | 'bar'> = {
      initial: 'foo',
      states: {
        foo: {
          on: {
    ...
    expect(instance.state.matches('foo', 'foo')).toEqual(true)
    expect(instance.state.matches('bar')).toEqual(true)
  ...
  test('should run entry and exit of parallel charts', () => {
    ...
    const chart: Statechart<typeof config, 'baz'> = {
      initial: 'baz',
      states: {
        baz: {
          entry: 'increaseCount',
    ...
    const chartB: Statechart<typeof config, 'baz'> = {
      initial: 'baz',
      states: {
        baz: {
          entry: 'increaseCount',
    ...
    const mainChart: Statechart<typeof config, 'foo' | 'bar'> = {
      initial: 'foo',
      states: {
        foo: {
          on: {
